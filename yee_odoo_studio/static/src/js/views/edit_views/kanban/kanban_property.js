odoo.define('yee_odoo_studio.KanbanViewProperty', function (require) {
"use strict";
    ...
    var KanbanViewProperty = Base.PropertyBase.extend({
        start: function () {
            ...
            // this.templates = {template1: {label: "Template Default", name: "template1", template: "KanBan.Template1", img: "/yee_odoo_studio/static/src/img/template1.png"},
            //     template2: {label: "Template 2", name: "template2", template: "KanBan.Template2", img: "/yee_odoo_studio/static/src/img/template2.png"}};
