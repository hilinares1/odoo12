...
var GanttModel = require('web_gantt_project_task_app.GanttModel');
var GanttRenderer = require('web_gantt_project_task_app.GanttRenderer');
var GanttController = require('web_gantt_project_task_app.GanttController');
...
var GanttView = AbstractView.extend({
    cssLibs: [
        "/web_gantt_project_task_app/static/lib/dhtmlxGantt/codebase/dhtmlxgantt.css"
    ],
    jsLibs: [
        "/web_gantt_project_task_app/static/lib/dhtmlxGantt/sources/dhtmlxcommon.js",
        "/web_gantt_project_task_app/static/lib/dhtmlxGantt/codebase/locale/locale" + locale_suffix + ".js"
    ],
