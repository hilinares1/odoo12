...
odoo.define('fal_sale_calculator.SectionAndNoteCalculator', function (require) {
...
var SectionAndNoteProductSelector = require('fal_product_attribute.section_and_note_backend');
...
var SectionAndNoteListRenderer = ListRenderer.extend({
    ...
    _onAddRecord: function (ev) {
        ...
        this.unselectRow().then(function () {
            ...
            } else if (context && pyUtils.py_eval(context).open_product_selector){
                self._rpc({
                    model: 'ir.model.data',
                    method: 'xmlid_to_res_id',
                    kwargs: {xmlid: 'fal_sale_product_selector.sale_product_selector_view_form'},
                }).then(function (res_id) {
                    self.do_action({
    ...
    _productsToRecords: function (products) {
        ...
        _.each(products, function (product){
            ...
            /*
            Added default_price_unit 06/05/2019
            Add default_fal_is_product_selector to recognize the product is added using product selector 03/06/2019
            */
            if (product.price_unit) {
                record['default_price_unit']= product.price_unit;
                record['default_fal_is_product_selector']= 'True';
            }
