                    ...
                    for orderpoint in location_orderpoints:
                        try:
                            ...
                            if float_compare(op_product_virtual, orderpoint.product_min_qty, precision_rounding=orderpoint.product_uom.rounding) <= 0:
                                # Falinwa modify begin here (use logic field to diffrent method. Use product_order_label_qty if logic fields is fix)
                                if orderpoint.logic == 'fix':
                                    qty = orderpoint.product_order_label_qty
                                else:  # end
