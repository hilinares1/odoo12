...
class PurchaseOrder(models.Model):
    ...
    untaxed_amount_group_curr = fields.Monetary(
        ...
        help="The untaxed amount in IFRS Currencies.",
        store=True,
    )
    taxed_amount_group_curr = fields.Monetary(
        compute='_amount_taxed_usd',
        string='IFRS Tax',
        help="The untaxed amount in IFRS Currencies.",
        store=True,
    )
    amount_total_group_curr = fields.Monetary(
        ...
        string='IFRS Total',
        help="The total amount in IFRS Currencies.",
        store=True,
    )
    ...
    untaxed_amount_comp_curr = fields.Monetary(
        compute='_amount_untaxed_usd',
        string='Company Untaxed Amount',
        help="The untaxed amount in Company Currency.",
        store=True,
    )
    ...
    amount_total_comp_curr = fields.Monetary(
        ...
        help="The total amount in Company Currency.",
        store=True,
    )
