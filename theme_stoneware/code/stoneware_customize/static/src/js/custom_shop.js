odoo.define('stoneware_customize.customs_shop_js', function(require){
    'use strict';
    ...
    $(document).on('click', '#load_more_products', function(){
        ...
        $.get("/shop/load_next_products", param_dict).then(function(data){
            if(data.trim()){
                ...
                $.getScript("/stoneware_customize/static/src/js/wishlist.js");
            }
            else{
        ...
        if($selEle.attr("data-shop_layout_type") === "0"){
            ...
            $.get("/shop/load_next_products", param_dict).then(function(data){
                if(data.trim()){
                    ...
                    $.getScript("/stoneware_customize/static/src/js/frontend_product_quick_view_js.js");
                }
                else{
                    $btnEle.text("No More Products").addClass("disabled");
                }
