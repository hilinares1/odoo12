...
class MailThread(models.AbstractModel):
    ...
    def message_post(self, body='', subject=None,
        ...
        # WORKAROUND FOR INTERNAL MESSAGE
        flagged_internal_message = False
        if subtype == 'mail.mt_internal_message':
            flagged_internal_message = True
        ...
        if flagged_internal_message:
            ...
            values['is_internal_message'] = True
        else:
            values['is_internal_message'] = False
        # END OF WORKAROUND
