odoo.define('web.HierarchyController', function (require) {
"use strict";
...
var HierarchySearchView = SearchView.include({
    start: function () {
        //this.options.disable_groupby = true; FIX THIS TO ONLY APPLY IN HIERARCHY MODE
