odoo.define('fal_product_attribute.OptionalAttributeModal', function (require) {
    "use strict";
...
var OptionalAttributeModal = Dialog.extend(ServicesMixin, ProductConfiguratorMixin, {
