odoo.define('fal_product_attribute.ProductAttributeMixin', function (require) {
'use strict';
...
var ProductAttributeMixin = {
    events: {
        ...
        //'change input[type="radio"],select': 'onChangeInput'
    },
