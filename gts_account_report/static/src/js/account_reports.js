odoo.define('gts_account_report.account_report', function (require) {
'use strict';
...
var accountReportsWidget = AbstractAction.extend(ControlPanelMixin, {
    ...
    renderButtons: function() {
        var self = this;
        this.$buttons = $(QWeb.render("gts_account_report.buttons", {buttons: this.buttons}));
        // bind actions
    ...
    add_edit_footnote: function(e) {
        ...
        var $content = $(QWeb.render('gts_account_report.footnote_dialog', {text: text, line: line_id}));
        var save = function() {
