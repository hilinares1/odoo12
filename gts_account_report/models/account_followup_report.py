...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_templates(self):
        ...
        templates['main_template'] = 'gts_account_report.template_followup_report'
        templates['line_template'] = 'gts_account_report.line_template_followup_report'
        return templates
    ...
    def print_followups(self, records):
        ...
        return self.env.ref('gts_account_report.action_report_followup').report_action(res_ids)
